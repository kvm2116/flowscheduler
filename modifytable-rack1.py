...
switch_dpid = "00:65:2c:23:3a:3e:ed:a9"			# TODO: switch dpid 
def getflows():
...
command200 = "curl -X POST -d '{\"switch\": \"00:65:2c:23:3a:3e:ed:a9\", \"name\":\"flow-mod-8\", \"table\":\"200\"," + \
          "\"cookie\":\"0\", \"priority\":\"0\", \"active\":\"true\", \"actions\":\"output=controller\"}'" + \
          " http://128.104.223.6:8080/wm/staticflowpusher/json"				# TODO: ip address, dpid 
